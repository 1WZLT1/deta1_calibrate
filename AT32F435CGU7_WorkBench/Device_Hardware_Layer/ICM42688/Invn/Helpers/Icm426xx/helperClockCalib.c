...
static int get_fastest_running_odr(struct inv_icm426xx * s, uint32_t *odr)
{
	...
	gyro_odr   = (ICM426XX_GYRO_CONFIG0_ODR_t)(s->register_cache.gyro_cfg_0_reg & BIT_GYRO_CONFIG0_ODR_MASK);
	accel_odr  = (ICM426XX_ACCEL_CONFIG0_ODR_t)(s->register_cache.accel_cfg_0_reg & BIT_ACCEL_CONFIG0_ODR_MASK);
...
static enum inv_icm426xx_sensor get_fastest_sensor(struct inv_icm426xx * s)
{
	ICM426XX_ACCEL_CONFIG0_ODR_t accel_odr = (ICM426XX_ACCEL_CONFIG0_ODR_t)(s->register_cache.accel_cfg_0_reg & BIT_ACCEL_CONFIG0_ODR_MASK);
	ICM426XX_GYRO_CONFIG0_ODR_t gyro_odr   = (ICM426XX_GYRO_CONFIG0_ODR_t)(s->register_cache.gyro_cfg_0_reg & BIT_GYRO_CONFIG0_ODR_MASK);
