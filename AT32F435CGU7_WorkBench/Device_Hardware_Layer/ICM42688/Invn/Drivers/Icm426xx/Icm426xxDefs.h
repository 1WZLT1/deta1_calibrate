...
#if defined(ICM42600_PORT)
#define ICM_WHOAMI ICM42600_WHOAMI
#elif defined(ICM42602_PORT)
#define ICM_WHOAMI ICM42602_WHOAMI
#elif defined(ICM42605_PORT)
#define ICM_WHOAMI ICM42605_WHOAMI
#elif defined(ICM42622_PORT)
#define ICM_WHOAMI ICM42622_WHOAMI
#elif defined(ICM42686_PORT)
#define ICM_WHOAMI ICM42686_WHOAMI
#elif defined(HAS_ICM42688)
#define ICM_WHOAMI ICM42652_WHOAMI
#elif defined(ICM42608_PORT)
#define ICM_WHOAMI ICM42608_WHOAMI
#else
#define ICM_WHOAMI 0
#warning "Please define which ICM variant is targeted. Possible values: ICM42600_PORT, ICM42602_PORT, ICM42605_PORT, ICM42686_PORT, HAS_ICM42688, ICM42622_PORT, ICM42608_PORT"
#endif
