...
def generator_deta20(dt, dts_file, gnss_state, bro_state, node_is_enabled):
    spi1      = dt.get_node("/deta20/spi_bus/spi1")
    lsm6dsrtr = dt.get_node("/deta20/spi_bus/spi1/lsm6dsrtr")
    iim42652  = dt.get_node("/deta20/spi_bus/spi1/iim42652")
    spa06     = dt.get_node("/deta20/spi_bus/spi1/spa06-003")

    spi2      = dt.get_node("/deta20/spi_bus/spi2")
    xv7011    = dt.get_node("/deta20/spi_bus/spi2/XV7011")

    i2c2      = dt.get_node("/deta20/i2c_bus/i2c2")
    qmc6309   = dt.get_node("/deta20/i2c_bus/i2c2/qmc6309")

    usart1    = dt.get_node("/deta20/usart_bus/usart1")
    usart2    = dt.get_node("/deta20/usart_bus/usart2")
    usart3    = dt.get_node("/deta20/usart_bus/usart3")

    tmr2      = dt.get_node("/deta20/tmr/tmr2")
...
#define DT_HardWare_Version                   0x0001020000
